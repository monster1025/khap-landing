...
- Юзернейм бота "Стражник" — `@king_gate_keeper_bot` (проверено вручную в Telegram: живой бот "Королевский Стражник" с фото и описанием). Ранее в других частях платформы (FAQ, `bot/wbproductinfo`, и др.) местами был указан ошибочный `@king_gatekeeper_bot` (без второго подчёркивания) — расхождение исправлено.
